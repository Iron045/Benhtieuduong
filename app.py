...
def train_models(X_train, y_train):
    ...
    param_svm = {'C': [0.1, 1, 10], 'kernel': ['linear', 'rbf', 'poly'], 'gamma': ['scale', 'auto']}
    param_logistic = {'C': [0.1, 1, 10], 'solver': ['lbfgs', 'liblinear']}
    param_mlp = {'hidden_layer_sizes': [(50,), (100,), (150,)], 'activation': ['relu', 'tanh'], 'solver': ['adam', 'sgd']}
